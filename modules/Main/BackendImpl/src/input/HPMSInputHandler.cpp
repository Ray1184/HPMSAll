...
hpms::InputHandler::InputHandler()
{
    ...
    keyToString[SDL_SCANCODE_BACKSPACE] = "BACK";
    keyToString[SDL_SCANCODE_APOSTROPHE] = "APOS";
    keyToString[SDL_SCANCODE_BACKSLASH] = "BSLASH";
    keyToString[SDL_SCANCODE_MINUS] = "MINUS";
    keyToString[SDL_SCANCODE_EQUALS] = "EQUALS";
    ...
    keyToString[SDL_SCANCODE_KP_0] = "0";
    keyToString[SDL_SCANCODE_KP_1] = "1";
    keyToString[SDL_SCANCODE_KP_2] = "2";
    keyToString[SDL_SCANCODE_KP_3] = "3";
    keyToString[SDL_SCANCODE_KP_4] = "4";
    keyToString[SDL_SCANCODE_KP_5] = "5";
    keyToString[SDL_SCANCODE_KP_6] = "6";
    keyToString[SDL_SCANCODE_KP_7] = "7";
    keyToString[SDL_SCANCODE_KP_8] = "8";
    keyToString[SDL_SCANCODE_KP_9] = "9";
    ...
    keyState[SDL_SCANCODE_BACKSPACE] = false;
    keyState[SDL_SCANCODE_APOSTROPHE] = false;
    keyState[SDL_SCANCODE_BACKSLASH] = false;
    keyState[SDL_SCANCODE_MINUS] = false;
    keyState[SDL_SCANCODE_EQUALS] = false;
    ...
    keyState[SDL_SCANCODE_KP_0] = false;
    keyState[SDL_SCANCODE_KP_1] = false;
    keyState[SDL_SCANCODE_KP_2] = false;
    keyState[SDL_SCANCODE_KP_3] = false;
    keyState[SDL_SCANCODE_KP_4] = false;
    keyState[SDL_SCANCODE_KP_5] = false;
    keyState[SDL_SCANCODE_KP_6] = false;
    keyState[SDL_SCANCODE_KP_7] = false;
    keyState[SDL_SCANCODE_KP_8] = false;
    keyState[SDL_SCANCODE_KP_9] = false;

...
function ammo_38_explosive:ret(idSuffix, amount)
    k = game_mechanics_consts:get()
    g = game_consts:get()
    insp = inspector:get()

    local path = g.res_refs.collectibles.AMMO_38_EXPLOSIVE.PATH
    local id = g.res_refs.collectibles.AMMO_38_EXPLOSIVE.ID .. '/' .. idSuffix
    ...
    local properties = {
        ...
        name = 'items_misc_ammo_38_explosive_name',
        description = 'items_misc_ammo_38_explosive_description',

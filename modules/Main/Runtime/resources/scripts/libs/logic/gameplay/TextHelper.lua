...
function create_text_label(id, text, lib, x, y, lines, order, font, width, size, color, shadowColor)
    ...
    shadowColor2.w = 0.75
    shadowColor3.w = 0.33   
    local nameBox = { lib.vec2(0, 0), lib.vec2(width or 300, 0), lib.vec2(width or 300, 200), lib.vec2(0, 200) }
